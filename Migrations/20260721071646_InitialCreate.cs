        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ButtonLink = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameTamil = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerAddress = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    City = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    TotalEstimatedAmount = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                    TransportChargeApplicable = table.Column<bool>(type: "boolean", nullable: false),
                    AdminRemarks = table.Column<string>(type: "text", nullable: true),
                    ExpectedDispatchDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DealerName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderStatusHistories_OrderRequests_OrderRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsLooseAvailable = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HighlightText = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    TrendDirection = table.Column<int>(type: "integer", nullable: false),
                    DisplayDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketHighlights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MarketHighlights_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackUnit = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    IsWholesale = table.Column<bool>(type: "boolean", nullable: false),
                    IsLoose = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackingTypes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TodayPrice = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MarketPrices_PackingTypes_PackingTypeId",
                        column: x => x.PackingTypeId,
                        principalTable: "PackingTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MarketPrices_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtOrderTime = table.Column<decimal>(type: "numeric(10,2)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderRequestItems_PackingTypes_PackingTypeId",
                        column: x => x.PackingTypeId,
                        principalTable: "PackingTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarketHighlights_ProductId",
                table: "MarketHighlights",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketPrices_PackingTypeId",
                table: "MarketPrices",
                column: "PackingTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketPrices_ProductId_PriceDate",
                table: "MarketPrices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderRequestItems_PackingTypeId",
                table: "OrderRequestItems",
                column: "PackingTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusHistories_OrderRequestId",
                table: "OrderStatusHistories",
                column: "OrderRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_PackingTypes_ProductId",
                table: "PackingTypes",
                column: "ProductId");
